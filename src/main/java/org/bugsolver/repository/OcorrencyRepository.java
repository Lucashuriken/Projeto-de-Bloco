    ...
    public class OcorrencyRepository {
        ...
        public Ocorrency salvar(Ocorrency o) {
            ...
            String[] line = new String[] {
                    ...
                    o.getTitulo(),
                    o.getDescricao(),
                    o.getAutorId() == null ? "" : o.getAutorId().toString(),
                    o.getGrupoId() == null ? "" : o.getGrupoId().toString(),
                    responsavelStr,
        ...
        /**
         * OBS: método simples que reescreve todo o CSV com a lista passada.
         * Útil para operações de update (fechar/atribuir).
         */
